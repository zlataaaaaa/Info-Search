...
class BooleanSearch:
    def __init__(self):
        self.inverted_index_file_name = '/home/naja/info_search/3/inverted_index.txt'
...
if __name__ == '__main__':
    ...
    print('стадион')
    print(boolean_search.search('стадион'))
    print('московский')
    print(boolean_search.search('московский'))
    print('стадион & московский')
    print(boolean_search.search('стадион & московский'))
    print('стадион | московский')
    print(boolean_search.search('стадион | московский'))
    print('стадион ! московский')
    print(boolean_search.search('стадион ! московский'))
    print('московский стадион')
    print(boolean_search.search('московский стадион'))
    print('стадион & московский | новость')
    print(boolean_search.search('омский & депутат | новость'))